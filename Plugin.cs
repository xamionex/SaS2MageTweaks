...
public class Plugin : BasePlugin
{
    ...
    public override void Load()
    {
        ...
        MageHpMultiplierFinalArena = Config.Bind("Mages", "MageHpMultiplierFinalArena", 1.0f, new ConfigDescription("Multiply mage HP by this value only in the final arena phase, when the mage becomes a boss. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        MageDamageMultiplier    = Config.Bind("Mages", "MageDamageMultiplier",     1.0f,   new ConfigDescription("Scales the damage dealt by mages. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        MagePoiseMultiplier     = Config.Bind("Mages", "MagePoiseMultiplier",      1.0f,   new ConfigDescription("Scales the poise (stagger resistance) of mages. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        MagePoiseDamageMultiplier = Config.Bind("Mages", "MagePoiseDamageMultiplier", 1.0f, new ConfigDescription("Scales the poise damage dealt by mages. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        MageLootMultiplier      = Config.Bind("Mages", "MageLootMultiplier",       1.0f,   new ConfigDescription("Scales the silver and material loot dropped by mages. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        ...
        MinionHpMultiplierFinalArena = Config.Bind("Minions", "MinionHpMultiplierFinalArena", 1.0f, new ConfigDescription("Multiply minion HP by this value only while their mage is in the final arena phase (boss fight). 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        ...
        MinionPoiseMultiplier   = Config.Bind("Minions", "MinionPoiseMultiplier",   1.0f,   new ConfigDescription("Scales the poise (stagger resistance) of minions summoned by mages. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        MinionPoiseDamageMultiplier = Config.Bind("Minions", "MinionPoiseDamageMultiplier", 1.0f, new ConfigDescription("Scales the poise damage dealt by minions summoned by mages. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        MinionLootMultiplier    = Config.Bind("Minions", "MinionLootMultiplier",    1.0f,   new ConfigDescription("Scales the silver and material loot dropped by minions. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        RegularEnemyHpMultiplier = Config.Bind("Regular Enemies", "RegularEnemyHpMultiplier", 1.0f, new ConfigDescription("Scales the HP of regular enemies (mobs). 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        RegularEnemyDamageMultiplier = Config.Bind("Regular Enemies", "RegularEnemyDamageMultiplier", 1.0f, new ConfigDescription("Scales the damage dealt by regular enemies (mobs). 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        RegularEnemyPoiseMultiplier = Config.Bind("Regular Enemies", "RegularEnemyPoiseMultiplier", 1.0f, new ConfigDescription("Scales the poise (stagger resistance) of regular enemies (mobs). 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        RegularEnemyPoiseDamageMultiplier = Config.Bind("Regular Enemies", "RegularEnemyPoiseDamageMultiplier", 1.0f, new ConfigDescription("Scales the poise damage dealt by regular enemies (mobs). 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        RegularEnemyLootMultiplier = Config.Bind("Regular Enemies", "RegularEnemyLootMultiplier", 1.0f, new ConfigDescription("Scales the silver and material loot dropped by regular enemies (mobs). 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        HazeburntHpMultiplier   = Config.Bind("Hazeburnt", "HazeburntHpMultiplier", 1.0f,   new ConfigDescription("Scales the HP of hazeburnt monsters. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        HazeburntDamageMultiplier = Config.Bind("Hazeburnt", "HazeburntDamageMultiplier", 1.0f, new ConfigDescription("Scales the damage dealt by hazeburnt monsters. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        HazeburntPoiseMultiplier = Config.Bind("Hazeburnt", "HazeburntPoiseMultiplier", 1.0f, new ConfigDescription("Scales the poise (stagger resistance) of hazeburnt monsters. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        HazeburntPoiseDamageMultiplier = Config.Bind("Hazeburnt", "HazeburntPoiseDamageMultiplier", 1.0f, new ConfigDescription("Scales the poise damage dealt by hazeburnt monsters. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        HazeburntLootMultiplier = Config.Bind("Hazeburnt", "HazeburntLootMultiplier", 1.0f, new ConfigDescription("Scales the silver and material loot dropped by hazeburnt monsters. 1.0 = vanilla.", new AcceptableValueRange<float>(0.1f, 10.0f)));
        ...
        HazeburntHpPerPlayer    = Config.Bind("Enemy HP Scaling", "HazeburntHpPerPlayer",    0.75f,  new ConfigDescription("Extra HP percent per additional player for hazeburnt monsters. 0.75 = +75% HP per extra player.", new AcceptableValueRange<float>(0.0f, 5.0f)));
        RegularEnemyHpPerPlayer = Config.Bind("Enemy HP Scaling", "RegularEnemyHpPerPlayer", 0.75f,  new ConfigDescription("Extra HP percent per additional player for regular enemies (mobs). 0.75 = +75% HP per extra player.", new AcceptableValueRange<float>(0.0f, 5.0f)));
        MinionHpPerPlayer       = Config.Bind("Enemy HP Scaling", "MinionHpPerPlayer",       0.75f,  new ConfigDescription("Extra HP percent per additional player for mage minions. 0.75 = +75% HP per extra player.", new AcceptableValueRange<float>(0.0f, 5.0f)));
        MageHpPerPlayer         = Config.Bind("Enemy HP Scaling", "MageHpPerPlayer",         1.0f,   new ConfigDescription("Extra HP percent per additional player for mages. 1.0 = +100% HP per extra player.", new AcceptableValueRange<float>(0.0f, 5.0f)));
        BossHpPerPlayer         = Config.Bind("Enemy HP Scaling", "BossHpPerPlayer",         1.0f,   new ConfigDescription("Extra HP percent per additional player for bosses (final arena mages, gauntlet mages, map bosses). 1.0 = +100% HP per extra player.", new AcceptableValueRange<float>(0.0f, 5.0f)));
    ...
    private static void TryRegisterModOptions()
    {
        ...
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(SkipNamedMages,         			mod, cat = "Skip Hunt Chases", "Skip Named Mages", order += 1);
