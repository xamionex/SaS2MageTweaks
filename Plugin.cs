...
public class Plugin : BasePlugin
{
    ...
    internal static ConfigEntry<float> MageHoverSpeedMultiplier;
    internal static ConfigEntry<float> MinionHoverSpeedMultiplier;
    internal static ConfigEntry<float> RegularEnemyHoverSpeedMultiplier;
    internal static ConfigEntry<float> HazeburntHoverSpeedMultiplier;
    internal static ConfigEntry<float> MageHoverAccelMultiplier;
    internal static ConfigEntry<float> MinionHoverAccelMultiplier;
    internal static ConfigEntry<float> RegularEnemyHoverAccelMultiplier;
    internal static ConfigEntry<float> HazeburntHoverAccelMultiplier;
    internal static ConfigEntry<float> EnemiesRunSpeedMultiplier;
    internal static ConfigEntry<float> EnemiesHoverSpeedMultiplier;
    internal static ConfigEntry<float> EnemiesHoverAccelMultiplier;
    internal static ConfigEntry<float> EnemiesLootMultiplier;
    ...
    public override void Load()
    {
        ...
        // Hunts
        SkipNamedMages          = Config.Bind("Hunts", "SkipNamedMages",          false,  "Skip hunt phases for named mission mages (e.g. Arzhan-Tin, Celus Zend).");
        SkipFatedMages          = Config.Bind("Hunts", "SkipFatedMages",          false,  "Skip hunt phases for fated mages (tiered mages shown with a tier number in mission select).");
        SkipNamelessMages       = Config.Bind("Hunts", "SkipNamelessMages",       false,  "Skip hunt phases for nameless mission mages (repeatable hunts, reward token_nameless).");
        SkipGauntletMages       = Config.Bind("Hunts", "SkipGauntletMages",       false,  "Skip hunt phases for gauntlet mages (each one immediately starts a 'boss' fight).");
        SkipWanderingMages      = Config.Bind("Hunts", "SkipWanderingMages",      false,  "Skip hunt phases for wandering/roaming mages.");
        SpawnAtFinalLocation    = Config.Bind("Hunts", "SpawnAtFinalLocation",    false,  "Teleport the primary mission mage directly to its arena entrance when skipping. Off by default, mages spawn at zone 0 and walk to the arena naturally. Only affects the non-invisible target mage; companion mages in the same hunt should be unaffected.");
        ReduceMageHp            = Config.Bind("Hunts", "ReduceMageHP",            false,  "Start mage fight with reduced HP (simulates hunt damage).");
        DisableWarpAndSummonMinions = Config.Bind("Hunts", "DisableWarpAndSummonMinions", false, "Disable the ambush summon phase for mages that have it (they will not warp away and summon minions mid-hunt).");
        DisableWarpAndAggressiveAttack = Config.Bind("Hunts", "DisableWarpAndAggressiveAttack", false, "Disable the ambush rage phase for mages that have it (they will not warp to the player and enter an aggressive attack state mid-hunt).");
        MagesTakeFullDamageDuringWarpIn = Config.Bind("Hunts", "MagesTakeFullDamageDuringWarpIn", false, "Mages take full damage while warping in instead of being invulnerable during the warp-in animation.");
        WarpSummonCountMultiplier  = Config.Bind("Hunts", "WarpSummonCountMultiplier",  1.0f, "Scales how many minions a mage summons each time it warps away and summons mid-hunt. 1.0 = vanilla (2 per warp summon). 0 = mages never summon minions when they warp. Also scales the fight's total minion pool when higher than the phase multiplier.");
        PhaseSummonCountMultiplier = Config.Bind("Hunts", "PhaseSummonCountMultiplier", 1.0f, "Scales how many minions a mage summons each time it casts a summon during a hunt phase. 1.0 = vanilla (2 per phase summon). 0 = mages never summon minions during phases. Also scales the fight's total minion pool when higher than the warp multiplier.");
        MinionsTakeFullDamageDuringWarpIn = Config.Bind("Hunts", "MinionsTakeFullDamageDuringWarpIn", false, "Minions take full damage while warping in instead of being invulnerable during the warp-in animation.");
        DropLootRelativeAmount  = Config.Bind("Hunts",    "DropLootRelativeAmount",  false,  "Drop bonus loot on death to compensate for skipped hunt phases.");
        DropLootMultiplier      = Config.Bind("Hunts",    "DropLootMultiplier",      1.0f,   "Scales the bonus loot dropped per skipped phase. 1.0 = one extra phase-equivalent drop total.");

        // Mages
        MageHpMultiplier        = Config.Bind("Mages", "MageHpMultiplier",        1.0f,   "Multiply mage starting HP by this value after the hunt-damage reduction.");
        ...
        MageRunSpeedMultiplier = Config.Bind("Mages", "MageRunSpeedMultiplier", 1.0f, "Scales the run speed of mages. 1.0 = vanilla.");
        MageHoverSpeedMultiplier = Config.Bind("Mages", "MageHoverSpeedMultiplier", 1.0f, "Scales the hover speed of mages. 1.0 = vanilla.");
        MageHoverAccelMultiplier = Config.Bind("Mages", "MageHoverAccelMultiplier", 1.0f, "Scales the hover acceleration of mages. 1.0 = vanilla.");
        ...
        MinionRunSpeedMultiplier = Config.Bind("Minions", "MinionRunSpeedMultiplier", 1.0f, "Scales the run speed of minions summoned by mages. 1.0 = vanilla.");
        MinionHoverSpeedMultiplier = Config.Bind("Minions", "MinionHoverSpeedMultiplier", 1.0f, "Scales the hover speed of minions summoned by mages. 1.0 = vanilla.");
        MinionHoverAccelMultiplier = Config.Bind("Minions", "MinionHoverAccelMultiplier", 1.0f, "Scales the hover acceleration of minions summoned by mages. 1.0 = vanilla.");
        ...
        MobsWontHitMinions      = Config.Bind("Regular Enemies", "MobsWontHitMinions",    false, "Regular enemies (mobs) will not damage or aggro minions.");
        MobsWontHitMages        = Config.Bind("Regular Enemies", "MobsWontHitMages",      false, "Regular enemies (mobs) will not damage or aggro mages.");
        MobsWontHitHazeburnt   = Config.Bind("Regular Enemies", "MobsWontHitHazeburnt",  false, "Regular enemies (mobs) will not damage or aggro hazeburnt monsters.");
        RegularEnemyRunSpeedMultiplier = Config.Bind("Regular Enemies", "RegularEnemyRunSpeedMultiplier", 1.0f, "Scales the run speed of regular enemies (mobs). 1.0 = vanilla.");
        RegularEnemyHoverSpeedMultiplier = Config.Bind("Regular Enemies", "RegularEnemyHoverSpeedMultiplier", 1.0f, "Scales the hover speed of regular enemies (mobs). 1.0 = vanilla.");
        RegularEnemyHoverAccelMultiplier = Config.Bind("Regular Enemies", "RegularEnemyHoverAccelMultiplier", 1.0f, "Scales the hover acceleration of regular enemies (mobs). 1.0 = vanilla.");

        // Hazeburnt
        HazeburntCountMultiplier = Config.Bind("Hazeburnt", "HazeburntCountMultiplier", 1.0f,  "Scales how many hazeburnt monsters can be active at once during hunts, invasions and roaming. 1.0 = vanilla (2 during hunts, 16 during Blue Heart invasions). 0 = no hazeburnt spawn.");
        ...
        HazeburntRunSpeedMultiplier = Config.Bind("Hazeburnt", "HazeburntRunSpeedMultiplier", 1.0f, "Scales the run speed of hazeburnt monsters. 1.0 = vanilla.");
        HazeburntHoverSpeedMultiplier = Config.Bind("Hazeburnt", "HazeburntHoverSpeedMultiplier", 1.0f, "Scales the hover speed of hazeburnt monsters. 1.0 = vanilla.");
        HazeburntHoverAccelMultiplier = Config.Bind("Hazeburnt", "HazeburntHoverAccelMultiplier", 1.0f, "Scales the hover acceleration of hazeburnt monsters. 1.0 = vanilla.");
        ...
        // Global Tweaks
        EnemiesRunSpeedMultiplier = Config.Bind("Global Tweaks", "EnemiesRunSpeedMultiplier", 1.0f, "Scales the run speed of every enemy type that has its Apply Settings toggle on. Stacks with the per-type run speed multipliers. 1.0 = vanilla.");
        EnemiesHoverSpeedMultiplier = Config.Bind("Global Tweaks", "EnemiesHoverSpeedMultiplier", 1.0f, "Scales the hover speed of every enemy type that has its Apply Settings toggle on. Stacks with the per-type hover speed multipliers. 1.0 = vanilla.");
        EnemiesHoverAccelMultiplier = Config.Bind("Global Tweaks", "EnemiesHoverAccelMultiplier", 1.0f, "Scales the hover acceleration of every enemy type that has its Apply Settings toggle on. Stacks with the per-type hover accel multipliers. 1.0 = vanilla.");
        EnemiesLootMultiplier = Config.Bind("Global Tweaks", "EnemiesLootMultiplier", 1.0f, "Scales the loot of every enemy type that has its Apply Settings toggle on. Stacks with the per-type loot multipliers. 1.0 = vanilla.");
    ...
    private static void TryRegisterModOptions()
    {
        ...
        // Hunts
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(SkipNamedMages,         			mod, cat = "Hunts", "Skip Named Mages", order += 1);
        ...
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(WarpSummonCountMultiplier,  		mod, cat, "Warp Summon Count Multiplier", order += 1);
        ...
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(DropLootRelativeAmount, 			mod, cat, "Extra Loot Based on Skipped Phases", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(DropLootMultiplier,     			mod, cat, "Hunt Loot Multiplier", order += 1);

        // Mages
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(MageHpMultiplier,       			mod, cat = "Mages", "Mage HP Multiplier", order += 1);
        ...
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(MageRunSpeedMultiplier,     		mod, cat, "Mage Run Speed Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(MageHoverSpeedMultiplier,   		mod, cat, "Mage Hover Speed Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(MageHoverAccelMultiplier,   		mod, cat, "Mage Hover Accel Multiplier", order += 1);
        ...
        // Minions
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(MinionHpMultiplier,           		mod, cat = "Minions", "Minion HP Multiplier", order += 1);
        ...
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(MinionHoverSpeedMultiplier, 		mod, cat, "Minion Hover Speed Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(MinionHoverAccelMultiplier, 		mod, cat, "Minion Hover Accel Multiplier", order += 1);
        ...
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(RegularEnemyHoverSpeedMultiplier, 	mod, cat, "Regular Enemy Hover Speed Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(RegularEnemyHoverAccelMultiplier, 	mod, cat, "Regular Enemy Hover Accel Multiplier", order += 1);
        ...
        // Hazeburnt
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(HazeburntCountMultiplier, 			mod, cat = "Hazeburnt", "Hazeburnt Count Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(HazeburntHpMultiplier,         		mod, cat, "Hazeburnt HP Multiplier", order += 1);
        ...
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(HazeburntHoverSpeedMultiplier, 	mod, cat, "Hazeburnt Hover Speed Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(HazeburntHoverAccelMultiplier, 	mod, cat, "Hazeburnt Hover Accel Multiplier", order += 1);
        ...
        // Global Tweaks
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(EnemiesRunSpeedMultiplier,   		mod, cat = "Global Tweaks", "Enemies Run Speed Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(EnemiesHoverSpeedMultiplier, 		mod, cat, "Enemies Hover Speed Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(EnemiesHoverAccelMultiplier, 		mod, cat, "Enemies Hover Accel Multiplier", order += 1);
        SaS2ModOptions.SaS2ModOptions.RegisterConfig(EnemiesLootMultiplier,         		mod, cat, "Enemies Loot Multiplier", order += 1);
